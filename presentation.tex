...
\includemedia[
  ...
  addresource=figs/vids/trajectoryLeader_follower.mp4,
  flashvars={
    %important: same path as in `addresource'
    source=figs/vids/trajectoryLeader_follower.mp4
  }
...
\includemedia[
  width=0.4\linewidth,
  totalheight=0.225\linewidth,
  addresource=matlabImplementation.mp4,
  transparent,
  activate=pagevisible,
  flashvars={
    %important: same path as in `addresource'
    source=matlabImplementation.mp4
    &autoplay=true
    &loop=false
  }
  ]{}{VPlayer.swf}
